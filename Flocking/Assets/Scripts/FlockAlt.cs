...
public class FlockAlt : MonoBehaviour
{
    [Header("Spawn Setup")]
    [SerializeField] private FlockUnitAlt flockUnitPrefab;
    ...
    public FlockUnitAlt[] allUnits { get; set; }
    ...
    {
        allUnits = new FlockUnitAlt[flockSize];
