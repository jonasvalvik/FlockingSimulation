...
public class FlockUnitAlt : MonoBehaviour
{
	...
	private List<FlockUnitAlt> cohesionNeighbours = new List<FlockUnitAlt>();
	private List<FlockUnitAlt> avoidanceNeighbours = new List<FlockUnitAlt>();
	private List<FlockUnitAlt> aligementNeighbours = new List<FlockUnitAlt>();
	private FlockAlt assignedFlock;
	...
	public void AssignFlock(FlockAlt flock)
	{
		assignedFlock = flock;
	}
